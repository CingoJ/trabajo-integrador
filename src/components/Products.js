import prod1 from "../assets/prod1-cableC.jpg";
import prod2 from "../assets/prod2-bateria.jpg";
import prod3 from "../assets/prod3-camara.jpg";
import prod4 from "../assets/prod4-flash.jpg";
import prod5 from "../assets/prod5-placaCarga.jpg";
import prod6 from "../assets/prod6-modulo.jpg";
